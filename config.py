...
# Timing (in seconds)
POLL_INTERVAL = float(os.getenv("POLL_INTERVAL", "0.35"))
FIXED_DELAY_MIN = 0
FIXED_DELAY_MAX = 0.18
STEP_DELAY_MIN = 0.08
STEP_DELAY_MAX = 0.22
...
# Human-like behavior (set HUMAN_LIKE_MODE=false for max speed)
HUMAN_LIKE_MODE = os.getenv("HUMAN_LIKE_MODE", "false").lower() == "true"
RANDOM_SCROLL_CHANCE = 0.05
RANDOM_PAUSE_CHANCE = 0.04
RANDOM_PAUSE_MIN = 0.15
RANDOM_PAUSE_MAX = 0.35
MOUSE_WOBBLE_CHANCE = 0.05
DOUBLE_CLICK_CHANCE = 0.01
